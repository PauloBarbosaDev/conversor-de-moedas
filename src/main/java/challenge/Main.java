...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!sair) {
            ...
            int opcao2 = escolherMoedaDestino(scanner, opcao1);
            if (opcao2 == SAIR) {
                sair = true;
                break;
            }
            ...
            System.out.println("Qual o valor que deseja converter? (Ex: 20.50)");
    ...
    private static int escolherMoedaDestino(Scanner scanner, int opcao1) {
        int opcao2;
        do {
